		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
            ...
            <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="重量" prop="weight">
							  ...
							  v-if="user_group === '管理员' || (form['mall_center_id'] && $check_field('set','weight')) || (!form['mall_center_id'] && $check_field('add','weight'))" :disabled="disabledObj['weight_isDisabled']"></el-input>
				...
				<el-form-item label="口味" prop="flavor">
							  ...
							  v-if="user_group === '管理员' || (form['mall_center_id'] && $check_field('set','flavor')) || (!form['mall_center_id'] && $check_field('add','flavor'))" :disabled="disabledObj['flavor_isDisabled']"></el-input>
            ...
            submit_goods(source_id,add_flag){
				let customize_field = []
							customize_field.push({"field_name":"规格","field_value":this.form.specifications});
									customize_field.push({"field_name":"重量","field_value":this.form.weight});
