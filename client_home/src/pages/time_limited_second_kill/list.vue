<template>
	<view class="page_time_limited_second_kill diy_list diy_list_page div_list_tml" id="time_limited_second_kill_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator class="btn btn-primary" :url="'./details?time_limited_second_kill_id=' + o['time_limited_second_kill_id']">查看详情</navigator>
					</view>
				</view>
			</view>
		</view>
...
<script>
	 ...
	 */
	to_nav(id) {
		this.$nav('/pages/time_limited_second_kill/details?time_limited_second_kill_id=' + id)
	},
	...
	created() {
		...
		var url_get_list = "~/api/time_limited_second_kill/get_list?timing_start_time_max=" + oNowDate +
