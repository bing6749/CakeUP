<template>
	<el-main class="bg edit_wrap">
      ...
      <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
        <el-form-item label="预约时间" prop="state">
            <el-date-picker
                v-model="form.appointment"
                type="datetime"
                placeholder="选择日期时间" />
<!--          <el-date-picker -->
<!--                          v-model="form['timing_start_time']" -->
<!--                          placeholder="选择计时器开始时间"-->
<!--                           >-->
<!--          </el-date-picker>-->
        </el-form-item>
      </el-col>
...
<script>
	...
	export default {
      ...
      get_obj_after(json, func){
        if (this.form["appointment"] && JSON.stringify(this.form["appointment"]).indexOf("-")===-1) {
          this.form["appointment"] = this.$toTime(parseInt(this.form["appointment"]), "yyyy-MM-dd hh:mm:ss")
        }
      },
