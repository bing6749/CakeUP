/*
 ...
 Source Server         : localhost mysql5.7.26
...
) ENGINE = MyISAM AUTO_INCREMENT = 106 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登陆访问时长' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `auth`  (
  `auth_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '授权 ID',
  ...
  `add` int(11) NOT NULL COMMENT '是否可增加',
  `del` int(11) NOT NULL COMMENT '是否可删除',
  `set` int(11) NOT NULL COMMENT '是否可修改',
  `get` int(11) NOT NULL COMMENT '是否可查看',
...
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车：' ROW_FORMAT = DYNAMIC;
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏：' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品类型' ROW_FORMAT = Dynamic;
...
CREATE TABLE `daily_specials`  (
  `daily_specials_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '每日特价ID',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品名',
  `type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型',
  `specifications` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格',
  `weight` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `flavor` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '口味',
  `original_price` int(11) NULL DEFAULT 0 COMMENT '原价',
  `current_special_price` int(11) NULL DEFAULT 0 COMMENT '现特价',
  `quality_guarantee_period` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '保质期',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '每日特价' ROW_FORMAT = Dynamic;
...
INSERT INTO `daily_specials` VALUES (2, '品名2', '类型2', '规格2', '重量2', '口味2', 2, 2, '保质期2', '/api/upload/1585462630112296961.jpg', 516, 63, 0, '2023-02-08 14:48:37', '2023-02-08 14:48:37');
...
INSERT INTO `daily_specials` VALUES (6, '品名6', '类型6', '规格6', '重量6', '口味6', 6, 6, '保质期6', '/api/upload/1585462586395066368.jpg', 534, 843, 0, '2023-02-08 14:48:37', '2023-02-08 14:48:37');
...
CREATE TABLE `goods`  (
  ...
  `source_field` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '来源字段：',
  `source_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '来源ID：',
  `user_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '添加人',
  PRIMARY KEY (`goods_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品信息：' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, '测试商品1', '/api/upload/good_1.jpg', '测试商品1', 110.00, 99.00, 0, 78, '分类一', 0, '', '/api/upload/img_1_1.jpg', '/api/upload/img_1_2.jpg', '/api/upload/img_1_3.jpg', '/api/upload/img_1_4.jpg', '/api/upload/img_1_5.jpg', '2023-03-31 18:21:49', '2025-02-20 10:43:48', '[{\"field_name\":\"规格\",\"field_value\":\"规格1\"},{\"field_name\":\"重量\",\"field_value\":\"重量1\"},{\"field_name\":\"口味\",\"field_value\":\"口味1\"}]', 'mall_center', 'mall_center_id', 1, 1);
...
CREATE TABLE `mall_center`  (
  `mall_center_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '商城中心ID',
  `specifications` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格',
  `weight` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `flavor` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '口味',
  `hits` int(11) NOT NULL DEFAULT 0 COMMENT '点击数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城中心' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of mall_center
-- ----------------------------
INSERT INTO `mall_center` VALUES (1, '规格1', '重量1', '口味1', 59, 295, 0, '测试商品1', '/api/upload/good_1.jpg', '测试商品1', 110.00, 99.00, 78, '分类一', '', '/api/upload/img_1_1.jpg', '/api/upload/img_1_2.jpg', '/api/upload/img_1_3.jpg', '/api/upload/img_1_4.jpg', '/api/upload/img_1_5.jpg', '2023-02-08 14:48:36', '2025-02-20 10:43:48');
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单：' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (1, '1739973465306705207', 1, '测试商品1', '/api/upload/good_1.jpg', 99.00, 110.00, 1, 99.00, NULL, '分类一', '田七', NULL, '13590509090', '广州市越秀区东风西路187号', NULL, 1, 0, '2025-02-19 21:57:45', '2025-02-19 21:57:50', '测试商品1', '已付款');
INSERT INTO `order` VALUES (2, '1740019406856519085', 1, '测试商品1', '/api/upload/good_1.jpg', 99.00, 110.00, 1, 99.00, NULL, '分类一', '田七', NULL, '13590509090', '广州市越秀区东风西路187号', NULL, 1, 0, '2025-02-20 10:43:26', '2025-02-20 10:43:48', '测试商品1', '已付款');
...
CREATE TABLE `second_kill_order`  (
  `second_kill_order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '秒杀订单ID',
  ...
  `weight` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `flavor` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '口味',
  `price_spike` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '秒杀价',
  `picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片',
  `user_no` int(11) NULL DEFAULT 0 COMMENT '用户编号',
  `user_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户姓名',
  `picking_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '取货类型',
  `contact_number` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系电话',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀订单' ROW_FORMAT = Dynamic;
...
-- Records of slides
-- ----------------------------
INSERT INTO `slides` VALUES (1, '轮播图1', '内容1', '/article/details?article=1', '/api/upload/1585459057618059264.jpg', 766, '2023-02-08 14:48:37', '2023-02-08 14:48:37');
INSERT INTO `slides` VALUES (2, '轮播图2', '内容2', '/article/details?article=2', '/api/upload/1585459009794605057.jpg', 459, '2023-02-08 14:48:37', '2023-02-08 14:48:37');
INSERT INTO `slides` VALUES (3, '轮播图3', '内容3', '/article/details?article=3', '/api/upload/1585459105181466625.jpg', 719, '2023-02-08 14:48:37', '2023-02-08 14:48:37');
...
CREATE TABLE `special_order`  (
  `special_order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '特价订单ID',
  `order_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单编号',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品名',
  `type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型',
  `specifications` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格',
  `weight` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `flavor` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '口味',
  `current_special_price` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '现特价',
  `picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片',
  `user_no` int(11) NULL DEFAULT 0 COMMENT '用户编号',
  `user_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户姓名',
  `picking_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '取货类型',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '特价订单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `system_user`  (
  `system_user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '系统用户ID',
...
CREATE TABLE `time_limited_second_kill`  (
  `time_limited_second_kill_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '限时秒杀ID',
  `product_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品名',
  `type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型',
  `specifications` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格',
  `weight` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `flavor` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '口味',
  `original_price` int(11) NULL DEFAULT 0 COMMENT '原价',
  `price_spike` int(11) NULL DEFAULT 0 COMMENT '秒杀价',
  `quality_guarantee_period` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '保质期',
  `picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片',
  `recommend` int(11) NOT NULL DEFAULT 0 COMMENT '智能推荐',
  `timer_title` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '计时器标题',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '限时秒杀' ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 1, '管理员', '2023-03-31 18:21:49', NULL, 0, 'admin', 'admin', 'bfd59291e825b5f2bbf1eb76569f8fe7', '', 0, '/api/upload/admin_avatar.jpg', '2023-03-31 17:35:13');
