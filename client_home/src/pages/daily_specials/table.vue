<template>
  <view class="page_daily_specials diy_table diy_table_tml" id="daily_specials_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/daily_specials/view?" v-show="user_group == '管理员' || $check_action('/daily_specials/table','add') || $check_action('/daily_specials/view','add')">添加</navigator>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/daily_specials/table','del') || $check_action('/daily_specials/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/daily_specials/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/daily_specials/table','set') || $check_action('/daily_specials/view','set') || $check_action('/daily_specials/view','get')" class="btn btn-primary">详情</navigator>
																							<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/special_order/view','add')" @click="to_form('/pages/special_order/view',o)">
									<span>购买</span>
								</a>
																						</view>
			</view>
