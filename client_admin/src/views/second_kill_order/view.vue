	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="订单编号" prop="order_no">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','order_no')) || (!form['second_kill_order_id'] && $check_field('add','order_no'))" :disabled="true"></el-input>
				...
				<el-form-item label="品名" prop="product_name">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','product_name')) || (!form['second_kill_order_id'] && $check_field('add','product_name'))" :disabled="disabledObj['product_name_isDisabled']"></el-input>
				...
				<el-form-item label="类型" prop="type">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','type')) || (!form['second_kill_order_id'] && $check_field('add','type'))" :disabled="disabledObj['type_isDisabled']"></el-input>
				...
				<el-form-item label="规格" prop="specifications">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','specifications')) || (!form['second_kill_order_id'] && $check_field('add','specifications'))" :disabled="disabledObj['specifications_isDisabled']"></el-input>
				...
				<el-form-item label="重量" prop="weight">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','weight')) || (!form['second_kill_order_id'] && $check_field('add','weight'))" :disabled="disabledObj['weight_isDisabled']"></el-input>
				...
				<el-form-item label="口味" prop="flavor">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','flavor')) || (!form['second_kill_order_id'] && $check_field('add','flavor'))" :disabled="disabledObj['flavor_isDisabled']"></el-input>
				...
				<el-form-item label="秒杀价" prop="price_spike">
												<el-input id="price_spike" v-model="form['price_spike']" placeholder="请输入秒杀价"
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','price_spike')) || (!form['second_kill_order_id'] && $check_field('add','price_spike'))" :disabled="disabledObj['price_spike_isDisabled']"></el-input>
				...
				<el-form-item label="图片" prop="picture">
						...
						:show-file-list="false" v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','picture')) || (!form['second_kill_order_id'] && $check_field('add','picture'))">
				...
				<el-form-item label="用户编号" prop="user_no">
							...
							<!--v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','user_no')) || (!form['second_kill_order_id'] && $check_field('add','user_no'))" :disabled="disabledObj['user_no_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','user_no')">{{form['user_no']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','user_no')) || (!form['second_kill_order_id'] && $check_field('add','user_no'))" id="user_no" v-model="form['user_no']" :disabled="disabledObj['user_no_isDisabled']">
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','user_name')) || (!form['second_kill_order_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>
				...
				<el-form-item label="联系电话" prop="contact_number">
						...
						v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','contact_number')) || (!form['second_kill_order_id'] && $check_field('add','contact_number'))">
					</el-input>
				...
				<el-form-item label="地址" prop="address">
							  ...
							  v-if="user_group === '管理员' || (form['second_kill_order_id'] && $check_field('set','address')) || (!form['second_kill_order_id'] && $check_field('add','address'))" :disabled="disabledObj['address_isDisabled']"></el-input>
