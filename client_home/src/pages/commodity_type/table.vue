<template>
  <view class="page_commodity_type diy_table diy_table_tml" id="commodity_type_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/commodity_type/view?" v-show="user_group == '管理员' || $check_action('/commodity_type/table','add') || $check_action('/commodity_type/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/commodity_type/table','del') || $check_action('/commodity_type/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/commodity_type/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/commodity_type/table','set') || $check_action('/commodity_type/view','set') || $check_action('/commodity_type/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
