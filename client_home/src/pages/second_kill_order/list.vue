<template>
	<view class="page_second_kill_order diy_list diy_list_page div_list_tml" id="second_kill_order_list">
		<!-- 筛选模块(开始) -->
		<view>
						...
						<view class="">
							<!-- 搜索栏 -->
								...
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
																			...
																			<uni-search-bar placeholder="搜索类型" @confirm="search" @cancel="cancel" cancelText="取消"
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?second_kill_order_id=' + o['second_kill_order_id']" class="btn btn-primary">查看详情</navigator>
		...
		data() {
			return {
				url_get_list: "~/api/second_kill_order/get_list?like=0",
					...
					list_user_user_no: [],
										// 取货类型选项列表
				list_picking_type: [{value:"全部",text:"全部"}],
